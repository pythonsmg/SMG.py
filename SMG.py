...
try:
	prox= requests.get('https://raw.githubusercontent.com/pythonsmg/data/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/pythonsmg/data/main/strings.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/pythonsmg/data/main/ua.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
